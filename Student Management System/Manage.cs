        ...
        public void menuStudent()
        {
            ...
            switch (Convert.ToInt32(menuStudentChoose))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Console.WriteLine("\n  * Please enter Student Name that you want to delete: ");
         ...
         public void menuLecturer()
         {
            ...
            switch (Convert.ToInt32(menuLectureChoose))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Console.WriteLine("\n  * Please enter Lecturer Name that you want to delete: ");
                    ...
                    break;
                case 5:
                    Console.WriteLine("\n  * Please enter Lecturer Name that you want to Update: ");
                    String lecUpdate = Console.ReadLine();
                    int lecCountUpdate = 0;
                    foreach (Lecturer lect in listLecturer)
                    {
                        if (lect.getName() == lecUpdate)
                        {
                            lecCountUpdate++;
                            lect.Input();
                            Console.ForegroundColor = ConsoleColor.Green;
